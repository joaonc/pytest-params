from typing import Any, Iterable, Literal, Sequence, Type, Union
...
_ScopeName = Union[Literal['session'], Literal['package'], Literal['module'], Literal['class'], Literal['function']]
